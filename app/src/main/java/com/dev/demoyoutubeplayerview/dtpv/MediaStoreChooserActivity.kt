...
class MediaStoreChooserActivity : Activity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        when (requestCode) {
            REQUEST_PERMISSION_STORAGE -> if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                start()
            }
    ...
    fun query(
        ...
        Collections.sort(
            list
        ) { o1: Map.Entry<Int, String>, o2: Map.Entry<Int, String> ->
            o1.value.compareTo(
                o2.value,
                ignoreCase = true
            )
    ...
    fun showBuckets() {
        ...
        if (buckets.size == 0) {
            ...
            alertDialogBuilder.setItems(
                ...
                val intent = Intent(
                    this@MediaStoreChooserActivity,
