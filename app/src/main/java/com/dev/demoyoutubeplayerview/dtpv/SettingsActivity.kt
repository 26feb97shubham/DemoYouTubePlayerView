...
import com.dev.demoyoutubeplayerview.dtpv.Utils.hasSAFChooser
import com.dev.demoyoutubeplayerview.dtpv.Utils.isPiPSupported
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            if (preferenceAutoPiP != null) {
                preferenceAutoPiP.isEnabled = this.context?.let { isPiPSupported(it) } == true
            }
            ...
            if (listPreferenceFileAccess != null) {
                val entries: ArrayList<String> =
                    ArrayList(Arrays.asList(*resources.getStringArray(R.array.file_access_entries)))
                val values: ArrayList<String> =
                    ArrayList(Arrays.asList(*resources.getStringArray(R.array.file_access_values)))
