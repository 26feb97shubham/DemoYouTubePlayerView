package com.dev.demoyoutubeplayerview.dtpv.youtube
...
import com.dev.demoyoutubeplayerview.dtpv.SeekListener
import com.dev.demoyoutubeplayerview.dtpv.youtube.views.CircleClipTapView
import com.dev.demoyoutubeplayerview.dtpv.youtube.views.SecondsView
...
class YouTubeOverlay(context: Context, private val attrs: AttributeSet?) :
    ...
    private fun initializeAttributes() {
        if (attrs != null) {
            ...
            // Set defaults
            arcSize = context.resources
                .getDimensionPixelSize(R.dimen.dtpv_yt_arc_size).toFloat()
            tapCircleColor = ContextCompat.getColor(
                context,
                R.color.dtpv_yt_tap_circle_color
            )
            circleBackgroundColor = ContextCompat.getColor(
                context,
                R.color.dtpv_yt_background_circle_color
            )
    ...
    fun tapCircleColorRes(@ColorInt resId: Int): YouTubeOverlay {
    ...
    var circleBackgroundColor: Int
        ...
        private set(value) {
            (findViewById<View>(R.id.circle_clip_tap_view) as CircleClipTapView).circleBackgroundColor = value
        }
    ...
    var animationDuration: Long
        ...
        private set(value) {
            (findViewById<View>(R.id.circle_clip_tap_view) as CircleClipTapView).animationDuration = value
        }
    ...
    private fun changeConstraints(forward: Boolean) {
        ...
        if (forward) {
            ...
            constraintSet.connect(
                secondsView.getId(), ConstraintSet.END,
                ConstraintSet.PARENT_ID, ConstraintSet.END
            )
        } else {
            constraintSet.clear(secondsView.getId(), ConstraintSet.END)
            constraintSet.connect(
                secondsView.getId(), ConstraintSet.START,
    ...
    init {
        ...
        (findViewById<View>(R.id.circle_clip_tap_view) as CircleClipTapView).performAtEnd = Runnable {
